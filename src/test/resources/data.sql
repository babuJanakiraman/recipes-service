...
insert into Recipe (name, vegetarian, servings, ingredients, instructions) values ('Pasta', true, 2, 'pasta, tomato sauce, cheese', 'Cook pasta, add tomato sauce, add cheese');
